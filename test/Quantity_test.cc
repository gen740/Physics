...
TEST(Quantity, Quantity_base) {
  ...
  EXPECT_TRUE(
      a.is_same_dim_as(Quantity_base<frac<int>{6, 10}, frac<int>{3, 6},
                                     frac<int>{4, 3}, frac<int>{3, 7}>()));
}
...
TEST(Quantity, Basic) {
  ...
  Quantity_base<frac<int>{3, 5}, frac<int>{1, 2}, frac<int>{4, 3},
                frac<int>{3, 7}>
      a2(7.4);
  Quantity_base<frac<int>{-2}, frac<int>{}, frac<int>{}, frac<int>{}> b(2.5);
  ...
  Quantity_base<frac<int>{1}, frac<int>{1}, frac<int>{2}, frac<int>{2}> x(3.);
  Quantity_base<frac<int>{1}, frac<int>{1}, frac<int>{2}, frac<int>{2}> y(4.);
  Quantity_base<frac<int>{1}, frac<int>{1}, frac<int>{2}, frac<int>{2}> z(5.);
